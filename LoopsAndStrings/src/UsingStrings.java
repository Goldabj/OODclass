...
public class UsingStrings {
	...
	public static void main(String[] args) {
		...
		/*DONE in class: print Bob's name, major and age. */
		System.out.println("name : " + name + " major: " + major + " age: " + age);
		
		/*
		 * DONE in class: Use the replace() method of String to replace "Party Game" with
		 * "Celebration Entertainment" in Bob's major.
		 */
		major = major.replace("Party Game", "Celebration Entertainment");
		

		/* DONE in class: print Bob's name, major, and age again. */
		System.out.println("name : " + name + " major: " + major + " age: " + age);

		/*
		 * DONE in class: Change Bob's major again, this time to be in all uppercase. Use
