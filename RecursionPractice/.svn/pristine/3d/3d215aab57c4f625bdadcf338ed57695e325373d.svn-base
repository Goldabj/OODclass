...
public class RecursionPractice {
	...
	public static String technicallyGramaticallyCorrect(int numberOfBuffalo) {
		...
		String buffalo = "Buffalo "
				+ technicallyGramaticallyCorrect(numberOfBuffalo - 1);
		return buffalo;
	}
	...
	public static String weirdoString(String stringInput) {
		...
		// Create a first character, and a new string that is what is changed of
	...
	public static int countNumberOf3sInPrimeFactorization(int inputNumber) {
		...
		// Count how many times it is divisble by 3
		int count = 0;
		if (inputNumber % 3 == 0) {
			count++;
		}
		return count + countNumberOf3sInPrimeFactorization(inputNumber / 3);
	}
	...
	public static boolean bracketMatch(String inputString) {
		...
		// Compare first and last chars, then remove if they are a match and
		// test again.
		if (inputString.charAt(0) == '(') {
			if (inputString.charAt(inputString.length() - 1) == ')') {
				return bracketMatch(inputString.substring(1,
	...
	public static boolean noDoubledLetters(String inputString) {
		// find the first and second characters in a row
	...
	public static boolean numbersGame(int startingNumber) {
		...
		// making a game decision
		// conditoins for dividing by 3
		if (startingNumber == 3) {
			return numbersGame(startingNumber / 3);
		}
		// divided by 27 since so it will be divisible by 3 again.
		if (startingNumber % 9 == 0) {
			return numbersGame(startingNumber / 3);
		}

		// conditions for subtracting by 7
		if (startingNumber % 7 == 1 || startingNumber % 7 == 3
				|| startingNumber % 7 == 6) {
