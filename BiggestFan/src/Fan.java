...
public class Fan {
	...
	public void drawOn(Graphics2D graphics2) {
		...
		double width = this.bladeLength * Fan.BLADE_ASPECT_RATIO;
		for(int i = 0; i <= numberOfBlades; i++) {
			Rectangle2D.Double blade = new Rectangle2D.Double(this.centerX, this.centerY - (.5*width), this.centerX + this.bladeLength, this.centerY);
	...
	private void drawFanBlade(Graphics2D grpahics2) {
